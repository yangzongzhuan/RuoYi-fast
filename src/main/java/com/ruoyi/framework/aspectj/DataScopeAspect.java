...
public class DataScopeAspect
{
     ...
     */
    public static void dataScopeFilter(JoinPoint joinPoint, User user, String userAlias, String deptAlias, String userField, String deptField, String permission)
    {
